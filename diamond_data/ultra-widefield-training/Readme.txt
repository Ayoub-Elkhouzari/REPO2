  ...
  Dear friends. This ultra-widefield-training.7z file contains two types of files: fundus images and label CSV file.
  There are 152 ultra-widefield images from 76 patients.
  CSV file label:
